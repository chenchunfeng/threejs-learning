...
rgbeLoader.loadAsync("./assets/flyLight/2k.hdr").then((texture) => {
...
gltfLoader.load("./assets/flyLight/model/flyLight.glb", (gltf) => {
  ...
  // 调整点光源强度
  const pointLight = gltf.scene.children[0].children[0];
...
gltfLoader.load("./assets/model/newyears_min.glb", (gltf) => {
  ...
  // 整体移动
  modelGroup.position.x = -19;
  modelGroup.position.z = -7.5;
